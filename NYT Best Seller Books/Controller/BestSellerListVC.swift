...
class BestSellerListVC: UIViewController, UITableViewDelegate, UITableViewDataSource {
    private let cellID = "BookListCell"
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: cellID, for: indexPath) as! BookListCell
    ...
    func tableView(_ tableView: UITableView, heightForRowAt indexPath: IndexPath) -> CGFloat {
        return view.frame.width/2 - 50 //100 = sum of labels height + height of divider line
    }
